...
1. git add .  - Update the files that need to be pushed to your local repository (Git)
2. git commit -m “Your message” - Actually adding them to your local repository 

3. git push -u origin main - Adding to your remote repository (GitHub)
